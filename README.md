[**CMD-guide**](https://www.stationx.net/windows-command-line-cheat-sheet/) &emsp; [**Git-guide**](https://cs.fyi/guide/git-cheatsheet) &emsp; [**Markdown-guide**](https://www.markdownguide.org/basic-syntax/)
# First Contributions
